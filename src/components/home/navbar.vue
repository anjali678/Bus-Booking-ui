          ...
          <div class="flex space-x-7">
            <div>
              ...
              <a href="#" class="flex items-center py-4 px-2">
                <img src="../../../src/assets/bus.jpg" alt="Logo" class="h-10 w-16 mr-2">
                <span class="font-semibold text-gray-500 text-lg"> BUS BOOKING</span>
              </a>
            </div>
...
<!--              <a href="" class="py-4 px-2 text-gray-500 font-semibold hover:text-green-500 transition duration-300">Services</a>-->
          ...
          <div class="md:hidden flex items-center">
            <button class="outline-none mobile-menu-button"  v-on:click="toggleNavbar()">
      ...
      <!-- mobile menu -->
      <div v-bind:class="{'hidden': !showMenu, 'flex': showMenu}" class="lg:flex lg:flex-grow items-center lg:hidden">
        <ul class="">
